...
(function (global, factory) {
...
})(undefined, function (exports, _GoogleApiComponent, _Marker, _InfoWindow, _HeatMap, _Polygon, _react, _propTypes, _reactDom, _String, _cancelablePromise, _invariant) {
  'use strict';
  ...
  var Map = exports.Map = function (_React$Component) {
    ...
    function Map(props) {
      ...
      var _this = _possibleConstructorReturn(this, (Map.__proto__ || (0, _getPrototypeOf2.default)(Map)).call(this, props));
    ...
    _createClass(Map, [{
      ...
      value: function componentDidMount() {
        ...
        if (this.props.centerAroundCurrentLocation) {
          if (navigator && navigator.geolocation) {
            this.geoPromise = (0, _cancelablePromise.makeCancelable)(new _promise2.default(function (resolve, reject) {
      ...
      value: function componentWillUnmount() {
        ...
        (0, _keys2.default)(this.listeners).forEach(function (e) {
      ...
      value: function loadMap() {
        ...
        if (this.props && this.props.google) {
          ...
          (0, _keys2.default)(mapConfig).forEach(function (key) {
      ...
      value: function render() {
        var style = (0, _assign2.default)({}, mapStyles.map, this.props.style, {
          display: this.props.visible ? 'inherit' : 'none'
        });

        var containerStyles = (0, _assign2.default)({}, mapStyles.container, this.props.containerStyle);

        return _react2.default.createElement('div', { style: containerStyles, className: this.props.className }, _react2.default.createElement('div', { style: style, ref: 'map' }, 'Loading map...'), this.renderChildren());
      }
    }]);
